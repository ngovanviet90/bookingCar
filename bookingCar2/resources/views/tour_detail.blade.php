...
@section('content')
	...
	<section>
		<div class="rows inner_banner inner_banner_4">
			<div class="container">
				<h2><span>Hoi An to Ba Na Hills - </span> Family Package</h2>
				<ul>
					<li><a href="#inner-page-title">Home</a>
					</li>
					<li><i class="fa fa-angle-right" aria-hidden="true"></i> </li>
					<li><a href="#inner-page-title" class="bread-acti">Hoi An & Da Nang</a>
					</li>
				</ul>
		...
		<div class="rows inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space">
				<div class="col-md-9">
					<!--====== TOUR TITLE ==========-->
					<div class="tour_head">
						<h2>Discover Ba Na Hill: Full-Day tour from Hoi An</h2>
                        <div class="tour_star">
					...
					<div class="tour_head1 hotel-book-room">
						...
						<div id="myCarousel1" class="carousel slide" data-ride="carousel">
							...
							<ol class="carousel-indicators carousel-indicators-1">
								<li data-target="#myCarousel1" data-slide-to="0"><img src="{{asset('best_travel_hoian/images/gallery/t1.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="1"><img src="{{asset('best_travel_hoian/images/gallery/t2.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="2"><img src="{{asset('best_travel_hoian/images/gallery/t3.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="3"><img src="{{asset('best_travel_hoian/images/gallery/t4.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="4"><img src="{{asset('best_travel_hoian/images/gallery/t5.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="5"><img src="{{asset('best_travel_hoian/images/gallery/s6.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="6"><img src="{{asset('best_travel_hoian/images/gallery/s7.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="7"><img src="{{asset('best_travel_hoian/images/gallery/s8.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="8"><img src="{{asset('best_travel_hoian/images/gallery/s9.jpg')}}" alt="Chania">
								</li>
							</ol>
							<!-- Wrapper for slides -->
							<div class="carousel-inner carousel-inner1" role="listbox">
								<div class="item active"> <img src="{{asset('best_travel_hoian/images/gallery/t1.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t2.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t3.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t4.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t5.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t6.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t7.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t8.jpg')}}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{asset('best_travel_hoian/images/gallery/t9.jpg')}}" alt="Chania" width="460" height="345"> </div>
							</div>
					...
					<div>
						<div class="dir-rat">
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="{{asset('best_travel_hoian/images/reviewer/4.jpg')}}" alt="">
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="{{asset('best_travel_hoian/images/reviewer/3.jpg')}}" alt="">
										<p>Orange Fab & Weld <span>19th January, 2017</span> </p>
									</div>
									<div class="col-md-9 dir-rat-right">
										<div class="dir-rat-star"> <i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-o" aria-hidden="true"></i> </div>
							...
							<div class="dir-rat-inn dir-rat-review">
								<div class="row">
									<div class="col-md-3 dir-rat-left"> <img src="{{asset('best_travel_hoian/images/reviewer/1.jpg')}}" alt="">
										<p>Orange Fab & Weld <span>19th January, 2017</span> </p>
									</div>
									<div class="col-md-9 dir-rat-right">
										<div class="dir-rat-star"> <i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-o" aria-hidden="true"></i> </div>
				...
				<div class="col-md-3 tour_r">
					...
					<div class="tour_right tour_offer">
						<div class="band1"><img src="{{asset('best_travel_hoian/images/offer.png" alt="" /> </div>
						<p>Special Offer</p>
					...
					<div class="tour_right tour_rela tour-ri-com">
						...
						<div class="tour_rela_1"> <img src="{{asset('best_travel_hoian/images/related1.png" alt="" />
						...
						<div class="tour_rela_1"> <img src="{{asset('best_travel_hoian/images/related2.png" alt="" />
							<h4>Mauritius 4Days / 3Nights</h4>
							<p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text</p> <a href="#" class="link-btn">View this Package</a> </div>
						<div class="tour_rela_1"> <img src="{{asset('best_travel_hoian/images/related3.png" alt="" />
