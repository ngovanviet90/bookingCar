...
<head>
    ...
    <link rel="stylesheet" href="{{asset('0935147435/css/font-awesome.min.css')}}">
    <!--== ALL CSS FILES ==-->
    <link rel="stylesheet" href="{{asset('0935147435/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('0935147435/css/materialize.css')}}">
    <link rel="stylesheet" href="{{asset('0935147435/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{asset('0935147435/css/mob.css')}}">
    <link rel="stylesheet" href="{{asset('0935147435/css/animate.css')}}">
...
<body>
        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                        <a href="main.html"><img src="{{asset('0935147435/images/logo.png')}}" alt="" />
						</a>
                    </div>
                </div>
                                                ...
                                                <div class="mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay menu-about" href="all-package.html">
                                                            <img src="{{asset('0935147435/images/sight/5.jpg')}}" alt="">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="places.html">
                                                            <img src="{{asset('0935147435/images/sight/1.jpg')}}" alt="">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="places-1.html">
                                                            <img src="{{asset('0935147435/images/sight/2.jpg')}}" alt="">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="places-2.html">
                                                            <img src="{{asset('0935147435/images/sight/3.jpg')}}" alt="">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s4">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="places-3.html">
                                                            <img src="{{asset('0935147435/images/sight/4.jpg')}}" alt="">
                ...
                <div class="row">
                    <div class="tourz-search-1">
                        ...
                        <div class="tourz-hom-ser">
                            <ul>
                                <li>
                                    <a href="booking-tour-package.html" class="waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="0.5s"><img src="{{asset('0935147435/images/icon/2.png')}}" alt=""> Tour</a>
                                </li>
                                <li>
                                    <a href="booking-flight.html" class="waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="1s"><img src="{{asset('0935147435/images/icon/31.png')}}" alt=""> Flight</a>
                                </li>
                                <li>
                                    <a href="booking-car-rentals.html" class="waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="1.5s"><img src="{{asset('0935147435/images/icon/30.png')}}" alt=""> Car Rentals</a>
                                </li>
                                <li>
                                    <a href="booking-hotel.html" class="waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="2s"><img src="{{asset('0935147435/images/icon/1.png')}}" alt=""> Hotel</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration="0.5s">
                        <!-- OFFER BRAND -->
                        <div class="band"> <img src="{{asset('0935147435/images/band.png')}}" alt="" /> </div>
                        <!-- IMAGE -->
                        <div class="v_place_img"> <img src="{{asset('0935147435/images/t5.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                        <!-- TOUR TITLE & ICONS -->
                        <div class="b_pack rows">
                            ...
                            <div class="col-md-4 col-sm-4 pack_icon">
                                <ul>
                                    <li>
                                        <a href="#"><img src="{{asset('0935147435/images/clock.png')}}" alt="Date" title="Tour Timing" /> </a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{asset('0935147435/images/info.png')}}" alt="Details" title="View more details" /> </a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{asset('0935147435/images/price.png')}}" alt="Price" title="Price" /> </a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{asset('0935147435/images/map.png')}}" alt="Location" title="Location" /> </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="0.7s">
                        <!-- OFFER BRAND -->
                        <div class="band"> <img src="{{asset('0935147435/images/band1.png')}}" alt="" /> </div>
                        <!-- IMAGE -->
                        <div class="v_place_img"> <img src="{{asset('0935147435/images/t1.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                        <!-- TOUR TITLE & ICONS -->
                        <div class="b_pack rows">
                            <!-- TOUR TITLE -->
                            <div class="col-md-8 col-sm-8">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="0.9s">
                        <div class="v_place_img"><img src="{{asset('0935147435/images/t2.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                        <div class="b_pack rows">
                            <div class="col-md-8 col-sm-8">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="1.1s">
                        <div class="v_place_img"><img src="{{asset('0935147435/images/t3.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                        <div class="b_pack rows">
                            <div class="col-md-8 col-sm-8">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="1.3s">
                        <div class="v_place_img"><img src="{{asset('0935147435/images/t4.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                        <div class="b_pack rows">
                            <div class="col-md-8 col-sm-8">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="1.5s">
                        <div class="v_place_img"><img src="{{asset('0935147435/images/t6.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                        <div class="b_pack rows">
                            <div class="col-md-8 col-sm-8">
        ...
        <div class="rows tb-space pad-top-o pad-bot-redu">
            <div class="container">
                ...
                <div class="col-md-6">
                    <a href="tour-details.html">
                        <div class="tour-mig-like-com">
                            <div class="tour-mig-lc-img"> <img src="{{asset('0935147435/images/listing/home.jpg')}}" alt=""> </div>
                ...
                <div class="col-md-3">
                    <a href="tour-details.html">
                        <div class="tour-mig-like-com">
                            <div class="tour-mig-lc-img"> <img src="{{asset('0935147435/images/listing/home3.jpg')}}" alt=""> </div>
                ...
                <div class="col-md-3">
                    <a href="tour-details.html">
                        <div class="tour-mig-like-com">
                            <div class="tour-mig-lc-img"> <img src="{{asset('0935147435/images/listing/home2.jpg')}}" alt=""> </div>
                            <div class="tour-mig-lc-con tour-mig-lc-con2">
                                <h5>India</h5>
                                <p>Starting from $2400</p>
                            </div>
                ...
                <div class="col-md-3">
                    <a href="tour-details.html">
                        <div class="tour-mig-like-com">
                            <div class="tour-mig-lc-img"> <img src="{{asset('0935147435/images/listing/home1.jpg')}}" alt=""> </div>
                            <div class="tour-mig-lc-con tour-mig-lc-con2">
                                <h5>Usa</h5>
                                <p>Starting from $2400</p>
                            </div>
                ...
                <div class="col-md-3">
                    <a href="tour-details.html">
                        <div class="tour-mig-like-com">
                            <div class="tour-mig-lc-img"> <img src="{{asset('0935147435/images/listing/home4.jpg')}}" alt=""> </div>
                            <div class="tour-mig-lc-con tour-mig-lc-con2">
                                <h5>London</h5>
                                <p>Starting from $2400</p>
                            </div>
                ...
                <div class="to-ho-hotel">
                    ...
                    <div class="col-md-4">
                        <div class="to-ho-hotel-con">
                            <div class="to-ho-hotel-con-1">
                                <div class="hot-page2-hli-3"> <img src="{{asset('0935147435/images/hci1.png')}}" alt=""> </div>
                                <div class="hom-hot-av-tic"> Available Tickets: 42 </div> <img src="{{asset('0935147435/images/hotels/1.jpg')}}" alt=""> </div>
                    ...
                    <div class="col-md-4">
                        <div class="to-ho-hotel-con">
                            <div class="to-ho-hotel-con-1">
                                <div class="hot-page2-hli-3"> <img src="{{asset('0935147435/images/hci1.png')}}" alt=""> </div>
                                <div class="hom-hot-av-tic"> Available Tickets: 520 </div> <img src="{{asset('0935147435/images/hotels/2.jpg')}}" alt=""> </div>
                            <div class="to-ho-hotel-con-23">
                                <div class="to-ho-hotel-con-2">
                                    <a href="hotel-details.html">
                    ...
                    <div class="col-md-4">
                        <div class="to-ho-hotel-con">
                            <div class="to-ho-hotel-con-1">
                                <div class="hot-page2-hli-3"> <img src="{{asset('0935147435/images/hci1.png')}}" alt=""> </div>
                                <div class="hom-hot-av-tic"> Available Tickets: 92 </div> <img src="{{asset('0935147435/images/hotels/3.jpg')}}" alt=""> </div>
                            <div class="to-ho-hotel-con-23">
                                <div class="to-ho-hotel-con-2">
                                    <a href="hotel-details.html">
                        ...
                        <div class="offer-l"> <span class="ol-1"></span> <span class="ol-2"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></span> <span class="ol-4">Standardized Budget Rooms</span>                            <span class="ol-3"></span> <span class="ol-5">$99/-</span>
                            <ul>
                                <li class="wow fadeInUp" data-wow-duration="0.5s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="{{asset('0935147435/images/icon/dis1.png')}}" alt="">
									</a><span>Free WiFi</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="0.7s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="{{asset('0935147435/images/icon/dis2.png')}}" alt=""> </a><span>Breakfast</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="0.9s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="{{asset('0935147435/images/icon/dis3.png')}}" alt=""> </a><span>Pool</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="1.1s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="{{asset('0935147435/images/icon/dis4.png')}}" alt=""> </a><span>Television</span>
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="1.3s">
                                    <a href="#!" class="waves-effect waves-light btn-large offer-btn"><img src="{{asset('0935147435/images/icon/dis5.png')}}" alt=""> </a><span>GYM</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container events events-1" id="inner-page-title">
                ...
                <table id="myTable">
                    <tbody>
                        ...
                        <tr>
                            <td>1</td>
                            <td><img src="{{asset('0935147435/images/iplace-1.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">Taj Mahal,Agra, India</a> </td>
                        ...
                        <tr>
                            <td>2</td>
                            <td><img src="{{asset('0935147435/images/iplace-2.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">Salesforce Summer, Dubai</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                        ...
                        <tr>
                            <td>3</td>
                            <td><img src="{{asset('0935147435/images/iplace-3.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">God Towers, TOKYO, JAPAN</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                        ...
                        <tr>
                            <td>4</td>
                            <td><img src="{{asset('0935147435/images/iplace-4.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">TOUR DE ROMANDIE, Switzerland</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                        ...
                        <tr>
                            <td>5</td>
                            <td><img src="{{asset('0935147435/images/iplace-5.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">TOUR DE POLOGNE, Poland</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                        ...
                        <tr>
                            <td>6</td>
                            <td><img src="{{asset('0935147435/images/iplace-6.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">Future of Marketing,Sydney, Australia</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                            <td class="e_h1">Australia</td>
                            <td><a href="booking.html" class="link-btn">Book Now</a> </td>
                        ...
                        <tr>
                            <td>7</td>
                            <td><img src="{{asset('0935147435/images/iplace-7.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">Eiffel Tower, Paris</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                        ...
                        <tr>
                            <td>8</td>
                            <td><img src="{{asset('0935147435/images/iplace-8.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">PARIS - ROUBAIX, England</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                        ...
                        <tr>
                            <td>9</td>
                            <td><img src="{{asset('0935147435/images/iplace-9.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">Dubai Beach Resort, Dubai</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                            <td class="e_h1">Dubai</td>
                            <td><a href="booking.html" class="link-btn">Book Now</a> </td>
                        ...
                        <tr>
                            <td>10</td>
                            <td><img src="{{asset('0935147435/images/iplace-4.jpg')}}" alt="" /><a href="hotels-list.html" class="events-title">TOUR DE POLOGNE, Poland</a> </td>
                            <td class="e_h1">16.12.2016</td>
                            <td class="e_h1">10.00 PM</td>
                            <td class="e_h1">Poland</td>
                            <td><a href="booking.html" class="link-btn">Book Now</a> </td>
            ...
            <div class="pla1 p-home container">
                ...
                <div class="popu-places-home">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 place">
                        <div class="col-md-6 col-sm-12 col-xs-12"> <img src="{{asset('0935147435/images/place2.jpg')}}" alt="" /> </div>
                    ...
                    <!-- POPULAR PLACES 2 -->
                    <div class="col-md-6 col-sm-6 col-xs-12 place">
                        <div class="col-md-6 col-sm-12 col-xs-12"> <img src="{{asset('0935147435/images/place1.jpg')}}" alt="" /> </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="popu-places-home">
                    <!-- POPULAR PLACES 3 -->
                    <div class="col-md-6 col-sm-6 col-xs-12 place">
                        <div class="col-md-6 col-sm-12 col-xs-12"> <img src="{{asset('0935147435/images/place3.jpg')}}" alt="" /> </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <!-- POPULAR PLACES 4 -->
                    <div class="col-md-6 col-sm-6 col-xs-12 place">
                        <div class="col-md-6 col-sm-12 col-xs-12"> <img src="{{asset('0935147435/images/place4.jpg')}}" alt="" /> </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/hotels/1.jpg')}}" alt=""> </div>
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/hotels/2.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/hotels/3.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/hotels/4.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/hotels/8.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="hot-page2-hom-pre">
                            <ul>
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/trends/1.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/trends/2.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/trends/3.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/trends/4.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="hot-page2-hom-pre">
                            <ul>
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/reviewer/1.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/reviewer/2.png')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/reviewer/3.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/reviewer/4.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
                                ...
                                <li>
                                    <a href="hotels-list.html">
                                        <div class="hot-page2-hom-pre-1"> <img src="{{asset('0935147435/images/reviewer/5.jpg')}}" alt=""> </div>
                                        <div class="hot-page2-hom-pre-2">
    ...
    <section>
        <div class="foot-mob-sec tb-space">
            <div class="rows container">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 family"> <img src="{{asset('0935147435/images/mobile.png')}}" alt="" /> </div>
                <!-- REQUEST A QUOTE -->
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="foot-mob-app">
                        ...
                        <a href="#"><img src="{{asset('0935147435/images/android.png')}}" alt=""> </a>
                        <a href="#"><img src="{{asset('0935147435/images/apple.png')}}" alt=""> </a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form tb-space">
            <div class="rows container">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 family">
                    <img src="{{asset('0935147435/images/family.png')}}" alt="" />
                </div>
            </div>
        </div>
    </section>-->
                ...
                <div class="col-md-8 col-sm-6 col-xs-12 testi-2">
                    ...
                    <div class="arrange">
                        <ul>
                            <!-- LOCATION MANAGER -->
                            <li>
                                <a href="#"><img src="{{asset('0935147435/images/Location-Manager.png')}}" alt=""> </a>
                            </li>
                            <!-- PRIVATE GUIDE -->
                            <li>
                                <a href="#"><img src="{{asset('0935147435/images/Private-Guide.png')}}" alt=""> </a>
                            </li>
                            <!-- ARRANGEMENTS -->
                            <li>
                                <a href="#"><img src="{{asset('0935147435/images/Arrangements.png')}}" alt=""> </a>
                            </li>
                            <!-- EVENT ACTIVITIES -->
                            <li>
                                <a href="#"><img src="{{asset('0935147435/images/Events-Activities.png')}}" alt=""> </a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!--========= Scripts ===========-->
    <script src="{{asset('0935147435/js/jquery-latest.min.js')}}"></script>
    <script src="{{asset('0935147435/js/bootstrap.js')}}"></script>
    <script src="{{asset('0935147435/js/wow.min.js')}}"></script>
    <script src="{{asset('0935147435/js/materialize.min.js')}}"></script>
    <script src="{{asset('0935147435/js/custom.js')}}"></script>
</body>
</html>
